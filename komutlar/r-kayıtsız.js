...
exports.run = (client, message, args) => {
    if (!message.member.roles.cache.has(`${client.config.teyitci}`) && !message.member.hasPermission('ADMINISTRATOR')) return message.channel.sendEmbed(new Discord.MessageEmbed().setDescription('**Bu komutu kullanabilmek için Yetkili olmak gerek!**').setColor("Black").setFooter("Deasn was here!"));
